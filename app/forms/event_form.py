...
class CreateEventForm(FlaskForm):
    ...
    start_time = DateTimeField('start_time', format='%Y-%m-%d %H:%M:%S', validators=[DataRequired()])
    end_time = DateTimeField('end_time', format='%Y-%m-%d %H:%M:%S', validators=[DataRequired()])
